...
%\begin{table}[h]
  ...
  %\begin{tabular}{ll}
    ...
    %\midrule
			...
			%Adv Accuracy - FGSM			& xxx		\\
			%Adv Accuracy - SPA			& 0.898		\\
			%
			%Avg Input Gradient			& xxx	\\
			%Max Input Gradient			& xxx\\
    %\bottomrule
  %\end{tabular}
%\end{table}
%
...
%\begin{figure}[h]
  %\begin{subfigure}[b]{0.75\columnwidth}
		%\centering
    %\includegraphics[width=\textwidth]{Results/confusion_matrix/xxx/similar}
    %\subcaption{Targeted BIM for similar Images}
    %\label{fig:exp:cm:xxx:similar}
  %\end{subfigure}
  %\begin{subfigure}[b]{0.75\columnwidth}
		%\centering
    %\includegraphics[width=\textwidth]{Results/confusion_matrix/xxx/different}
    %\subcaption{Targeted BIM for different Images}
    %\label{fig:exp:cm:xxx:different}
  %\end{subfigure}
  %\caption{Targeted Basic Iterative Method, $\epsilon = 0.03$, 15 iterations}
  %\label{fig:exp:cm:xxx}
%\end{figure}
