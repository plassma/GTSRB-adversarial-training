...
\settitle{\thesistitle}{Effect of adversarial defense strategies on the decision boundary of convolutional neural networks} % Sets English and German version of the title (both can be English or German).
...
%todo: training params beschreiben
...
%todo: lenet-5 mehr training - nicht komplex genug?
% alle enthalten artifacts - feiner je deeper net
