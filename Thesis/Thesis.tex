...
The most important attack, defense strategy and model parameters will be presented in a table for each combination of model architecture and defense strategy.
...
\begin{figure}[h]
  \begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/confusion_matrix/alex_adv/similar}%eps=0.01, iter=15
    \subcaption{Targeted BIM for similar Images}
...
\begin{figure}[h]
  \begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/confusion_matrix/alex_adv_gradreg/similar}%eps=0.01, iter=15
    \subcaption{Targeted BIM for similar Images}
    \label{fig:exp:cm:alex_adv_gradreg:similar}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/confusion_matrix/alex_adv_gradreg/different}
    \subcaption{Targeted BIM for different Images}
