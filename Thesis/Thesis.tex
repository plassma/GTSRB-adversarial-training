...
Thus, typical classifiers being able to discriminate among more than two classes have multiple decision boundaries.
The shape of the decision boundary exposes interesting properties about the decision process: what features of the input-vector are respected with what weight.
The smoothness of the decision boundary can be interpreted as a measure of how well a classifier generalizes: 
