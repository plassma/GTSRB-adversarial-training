...
\begin{table}[h]
	\noindent\makebox[\textwidth]{%
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}%
				\hline
				\bfseries Loss & \bfseries Test & \bfseries Adv1& \bfseries Adv2& \bfseries Adv3& \bfseries Adv4& \bfseries Adv5& \bfseries Adv6& \bfseries Adv7& \bfseries Adv8& \bfseries Adv9& \bfseries Adv10\\
				\hline
				\csvreader[
					no head,table head=\hline,late after line=\\\hline]
					{graphics/Results/iterative_adversarial_training/lenet-5/accuracies.csv}{}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{1\columnwidth}
		\subcaption{Adversarials generated for lenet-5 with adversarial loss function}
    \label{fig:exp:iat:lenet-5:adversarials:with}
		\includegraphics[width=\textwidth]{Results/iterative_adversarial_training/lenet-5/lenet-5_with}
		\vspace{15mm}
  \end{subfigure}
  \begin{subfigure}[b]{1\columnwidth}
		\subcaption{Adversarials generated for lenet-5 without adversarial loss function}
    \label{fig:exp:iat:lenet-5:adversarials:without}
		\includegraphics[width=\textwidth]{Results/iterative_adversarial_training/lenet-5/lenet-5_without}
  \end{subfigure}
...
The adversarial images of the remaining architectures can be found in the \nameref{appendix}.
...
Therefore the heatmaps for the remaining architectures were omitted in the Results chapter, and put into the \nameref{appendix}.
...
\begin{table}[h]
	\noindent\makebox[\textwidth]{%
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}%
				\hline
				\bfseries Epoch & \bfseries Test & \bfseries Adv1& \bfseries Adv2& \bfseries Adv3& \bfseries Adv4& \bfseries Adv5& \bfseries Adv6& \bfseries Adv7& \bfseries Adv8& \bfseries Adv9& \bfseries Adv10\\
				\hline
				\csvreader[
					no head,table head=\hline,late after line=\\\hline]
					{graphics/Results/iterative_adversarial_training/alex/accuracies.csv}{}
					{\csvcoli & \csvcolii & \csvcoliii & \csvcoliv & \csvcolv & \csvcolvi & \csvcolvii & \csvcolviii & \csvcolix & \csvcolx & \csvcolxi & \csvcolxii}
		\end{tabular}
		}
...
\begin{table}[h]
	\noindent\makebox[\textwidth]{%
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}%
				...
				\csvreader[
					no head,table head=\hline,late after line=\\\hline]
					{graphics/Results/iterative_adversarial_training/vgg19/accuracies.csv}{}
					{\csvcoli & \csvcolii & \csvcoliii & \csvcoliv & \csvcolv & \csvcolvi & \csvcolvii & \csvcolviii & \csvcolix & \csvcolx & \csvcolxi & \csvcolxii}
		\end{tabular}
		}
		\caption{Accuracies during training with adversarial loss}
...
%todo: resnet-50 nicht trainierbar als ergebnis verkaufen? -> in Mail inkludieren
...
\begin{table}[h]
	\noindent\makebox[\textwidth]{%
		\begin{tabular}{|>{\bfseries}c||c|c|c|c|c|c|}%
				\hline
				\bfseries architecture/adv & \bfseries lenet-5/-& \bfseries lenet-5/+ & \bfseries alex/- & \bfseries alex/+ & \bfseries vgg19/- & \bfseries vgg19/+\\
				\hline\hline
				\csvreader[
					head=true,separator=semicolon,table head=\hline,late after line=\\\hline]
					{graphics/Results/iterative_adversarial_training/cross_robustness_rounded.csv}{}
...
%todo: in conclusion maybe shared gradient is responsible for transferred vul.
...
\\
\textbf{How does network complexity and -depth influence the defensibility against adversarial attacks?}\\
This question can be answered for the for the architectures experiments could successfully be performed with (lenet-5, alexnet, vgg19) and the defensibility against the FGSM attack:
...
\textbf{What effects do adversarial defense strategies have on the appearance of adversarial examples generated by adversarial attacks?}\\
As expected, adversarial training increased the apparent similarity between adversarials generated by the FGSM and their targets.
...
Certainly, the evaluation of additional attack and defense strategies as well as network architectures is needed for gaining more insights. The two strategies used in this work had opposite effects on some properties of the decision boundary, the results of the analyzes performed in this work allow no general conclusion about the effects of adversarial defense strategies on the decision boundary of convolutional neural networks.
...
\section{Appendix}
\label{appendix}
\subsection{Adversary Inputs}
\subsubsection{alexnet}

\begin{figure}[h]
	\centering
  \begin{subfigure}[b]{1\columnwidth}
		\subcaption{Adversarials generated for alexnet with adversarial loss function}
    \label{fig:exp:iat:alex:adversarials:with}
		\includegraphics[width=\textwidth]{Results/iterative_adversarial_training/alex/alex_with}
		\vspace{15mm}
  \end{subfigure}
  \begin{subfigure}[b]{1\columnwidth}
		\subcaption{Adversarials generated for alexnet without adversarial loss function}
    \label{fig:exp:iat:alex:adversarials:without}
		\includegraphics[width=\textwidth]{Results/iterative_adversarial_training/alex/alex_without}
  \end{subfigure}
  \caption{Adversarials created for alexnet}
	\label{fig:exp:iat:alex:adversarials}
\end{figure}
...
\begin{figure}[h]
	\centering
  \begin{subfigure}[b]{1\columnwidth}
		\subcaption{Adversarials generated for vgg19 with adversarial loss function}
    \label{fig:exp:iat:vgg19:adversarials:with}
		\includegraphics[width=\textwidth]{Results/iterative_adversarial_training/vgg19/vgg19_with}
		\vspace{15mm}
  \end{subfigure}
  \begin{subfigure}[b]{1\columnwidth}
		\subcaption{Adversarials generated for alexnet without adversarial loss function}
    \label{fig:exp:iat:vgg19:adversarials:without}
		\includegraphics[width=\textwidth]{Results/iterative_adversarial_training/vgg19/vgg19_without}
  \end{subfigure}
  \caption{Adversarials created for vgg19}
	\label{fig:exp:iat:vgg19:adversarials}
\end{figure}
...
\begin{figure}[h]
	\begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/iterative_adversarial_training/alex/heatmaps/normal_0}
    \subcaption{Heatmap of undefended alexnet in \hspace{\textwidth} iteration 1}
    \label{fig:exp:iat:alex-heat:normal_0}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/iterative_adversarial_training/alex/heatmaps/normal_1}
    \subcaption{Heatmap of undefended alexnet in \hspace{\textwidth} iteration 10}
    \label{fig:exp:iat:alex-heat:normal_1}
  \end{subfigure}

	\begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/iterative_adversarial_training/alex/heatmaps/adv_0}
    \subcaption{Heatmap of adversarially trained alexnet in iteration 1}
    \label{fig:exp:iat:alex-heat:adv_0}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/iterative_adversarial_training/alex/heatmaps/adv_1}
    \subcaption{Heatmap of adversarially trained alexnet in iteration 10}
    \label{fig:exp:iat:alex-heat:adv_1}
  \end{subfigure}
  \caption{Heatmaps for alexnet correctly classifying 'Vehicles over 3.5 metric tons prohibited'}
	\label{fig:exp:iat:alex:heatmap}
\end{figure}
...
\begin{figure}[h]
	\begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/iterative_adversarial_training/vgg19/heatmaps/normal_0}
    \subcaption{Heatmap of undefended vgg19 in \hspace{\textwidth} iteration 1}
    \label{fig:exp:iat:vgg19-heat:normal_0}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/iterative_adversarial_training/vgg19/heatmaps/normal_1}
    \subcaption{Heatmap of undefended vgg19 in \hspace{\textwidth} iteration 10}
    \label{fig:exp:iat:vgg19-heat:normal_1}
  \end{subfigure}

	\begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/iterative_adversarial_training/vgg19/heatmaps/adv_0}
    \subcaption{Heatmap of adversarially trained vgg19 in iteration 1}
    \label{fig:exp:iat:vgg19-heat:adv_0}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\columnwidth}
		\centering
    \includegraphics[width=\textwidth]{Results/iterative_adversarial_training/vgg19/heatmaps/adv_1}
    \subcaption{Heatmap of adversarially trained vgg19 in iteration 10}
    \label{fig:exp:iat:vgg19-heat:adv_1}
  \end{subfigure}
  \caption{Heatmaps for vgg19 correctly classifying 'Vehicles over 3.5 metric tons prohibited'}
	\label{fig:exp:iat:vgg19:heatmap}
\end{figure}
\end{document}