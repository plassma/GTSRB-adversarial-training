...
%todo: add motivation for different architectures
...
The adversarial images of the remaining architectures can be found in the appendix. %TODO: add ref to appendix
...
%todo: add more heatmaps in appendix - 2 per architecture - link here
